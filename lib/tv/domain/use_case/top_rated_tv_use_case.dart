...
class GetTopRatedTvUseCase extends BaseUseCase<List<TvShow>,NoParameters>{
  final TvRepository tvRepository;

  GetTopRatedTvUseCase({required this.tvRepository});
  @override
  Future<Either<Failure, List<TvShow>>> call(NoParameters parameters)async {
    return await tvRepository.getToRatedTvShow();
  }
}
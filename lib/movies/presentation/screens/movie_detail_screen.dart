...
import 'package:movies_app/movies/presentation/widgets/youtube_widget.dart';
                  ...
                  child: FadeInUp(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(state.moviesDetailsState.title,
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.moviesDetailsState.releaseData
                                      .split('-')[0],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.moviesDetailsState.voteAverage / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      color: Colors.white,
                                  ...
                                  const SizedBox(width: 4.0),
                                  Text(
                                    '(${state.moviesDetailsState.voteAverage})',
                                    style: const TextStyle(
                                      fontSize: 10.0,
                                      color: Colors.white,
                                      fontWeight: FontWeight.w500,
                              ...
                              const SizedBox(width: 16.0),
                              Text(
                                _showDuration(state.moviesDetailsState.runtime),
                                style: const TextStyle(
                          ...
                          Text(
                            state.moviesDetailsState.overView,
                            style: const TextStyle(
                              fontSize: 14.0,
                              color: Colors.white,
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.moviesDetailsState.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
